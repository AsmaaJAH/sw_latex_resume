...
\entrypositionstyle {\textbf{\textcolor{lightblack}{Web Frontend Development}}\hfill \entrylocationstyle
{Present}}

\begin{itemize}[itemsep=0pt, parsep=0pt, topsep=0pt]
  \item {\footnotesize Simple New \textbf{\textcolor{cyan}{\href{https://github.com/AsmaaJAH/simple-university-fullstack-web-project/tree/feature/apply_page}{ University Project}}}: currently working on a demo project to learn MVC full-stack web development using  React.js,{\textcolor{cyan}{\href{https://github.com/AsmaaJAH/Foundational-Csharp-with-Microsoft/tree/main}{ C\# language }}}, HTML (JSX in React), CSS,  Node.js, ASP.NET core, EF Core, SQL, Postman RESTful API.}
 \end{itemize}
 %-------------------------------------------------
